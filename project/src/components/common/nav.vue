    ...
    export default {
      ...
      data(){
          return{
           comnav:{
              go: [
                {name: "公司简介", eName: "companyProfile"},
                {name: "公司文化", eName: "companyCulture"},
                {name: "组织架构", eName: "organizationChart"},
      ...
      methods:{
       getNav(){
          ...
          switch (path) {
            ...
            case '/teamStyle':this.curKey='go';this.titKey='go';break;
            case '/businessArea':
            case '/projectResult':
            case '/resultShow':
